...
- (void)setUpUnderLineOffset:(CGFloat)offsetX rightLabel:(UILabel *)rightLabel leftLabel:(UILabel *)leftLabel
{
    ...
    CGFloat distance = offsetX - leftIndex * YZScreenW;
    
    if (distance <= YZScreenW / 2) {
        self.underLine.yz_width = 15 + distance / (YZScreenW / 2) * centerDelta;
    } else {
        distance = distance - YZScreenW / 2;
        self.underLine.yz_width = centerDelta + 15 - distance / (YZScreenW / 2) * centerDelta;
        self.underLine.yz_x = leftLabel.yz_centerX - 7.5 + distance / (YZScreenW / 2) * centerDelta;
    }
